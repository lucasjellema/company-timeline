...
- [ ] paste CSV data (e.g. in new story)
...
- configure icons for event types and use the in addition to toppled triangle (default icon)
...
* [ ] add image to event (paste image,  upload file)
